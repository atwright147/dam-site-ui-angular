...
export class CarouselComponent implements AfterViewInit, OnInit {
  ...
  rotateCarousel(): void {
    ...
    this.hostElement.nativeElement.style.transform = 'translateZ(' + -this.radius + 'px) ' + this.rotateFn + '(' + angle + 'deg)';

    const cellInner = this.hostElement.nativeElement.querySelectorAll('.carousel__cell');
